 ...
 */
public class WXEntryaActivity extends BaseActivity implements IWXAPIEventHandler {

    private static final int RETURN_MSG_TYPE_LOGIN = 1;
    private static final int RETURN_MSG_TYPE_SHARE = 2;
    private static final String TAG = "WXEntryaActivity";
            ...
            case BaseResp.ErrCode.ERR_OK:
                ...
                switch (resp1.getType()) {
                    case RETURN_MSG_TYPE_SHARE:
                        Toast.makeText(this, "微信分享返回", Toast.LENGTH_LONG).show();
                        finish();
                        break;
