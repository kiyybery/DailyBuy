...
import izhipeng.dailybuy.bean.City;
import izhipeng.dailybuy.db.DBHelper;
import izhipeng.dailybuy.library.PreferencesUtil;
import izhipeng.dailybuy.widget.MyLetterListView;
    ...
    public class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    PreferencesUtil.put(DailyBuyApplication.KEY_CITY, city_adapter.getName());
