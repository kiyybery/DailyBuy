...
public class UIHelper {
    ...
    public static Dialog buildConfirm(Context context, String title, String left, String right, View.OnClickListener listener_left, View.OnClickListener listener_right) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        AlertDialog dialog = builder.create();
        dialog.show();
        Window window = dialog.getWindow();
        View view = View.inflate(context, R.layout.dialog_nce2_confirm, null);
        RelayoutViewTool.relayoutViewWithScale(view, DailyBuyApplication.screenWidthScale);
    ...
    public static Dialog buildAlert(Context context, String title, String content, String str_button, View.OnClickListener listener) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        AlertDialog dialog = builder.create();
        dialog.show();
        Window window = dialog.getWindow();
    ...
    public static Dialog buildDialog(Context context, String title, String left, String right, View.OnClickListener listener_left, View.OnClickListener listener_right) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        AlertDialog dialog = builder.create();
        dialog.show();
        Window window = dialog.getWindow();
