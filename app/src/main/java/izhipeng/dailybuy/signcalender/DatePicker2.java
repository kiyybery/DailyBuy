package izhipeng.dailybuy.signcalender;
...
//        lpLeft.setMargins(40,0,0,0);
        ...
        lpYear.addRule(RelativeLayout.LEFT_OF,ID_tvMonth);
...
//        lpEnsure.setMargins(0,0,40,0);
        ...
        tvYear.setTextColor(getResources().getColor(R.color.uc_display_content));

        // 月份显示
        tvMonth = new TextView(context);
        tvMonth.setId(ID_tvMonth);
        tvMonth.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
        tvMonth.setTextColor(getResources().getColor(R.color.uc_display_content));
